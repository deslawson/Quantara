  ...
  const sectionsData = [
    {
      ...
      content: [
        {
          type: 'text',
          value: 'Welcome to Quantara documentation.',
        },
        {
          type: 'text',
          value:
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          value: 'What is Quantara?',
        },
        {
          type: 'text',
          value:
            'Quantara is a Web3 platform that leverages blockchain technology to facilitate secure transactions, staking, and asset management without intermediaries, enabling users to amplify their investments in digital assets through decentralized lending protocols and automated market makers (AMMs).',
        },
        {
          type: 'text',
        ...
        },
        {
          ...
          items: [
            ...
            'Cross-Chain Compatibility: Quantara supports multiple blockchains, including Starknet, for a seamless and efficient user experience, providing more liquidity and flexibility across the DeFi ecosystem.',
          ],
        },
      ],
    },
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'Currently, Quantara only allows you to open a single position.',
      ...
      content: [
        {
          type: 'text',
          value:
            'To get started with Quantara and fully leverage its features, you’ll need to set up a compatible Web3 wallet. Follow the steps below to set up your wallet and connect it to Quantara:',
        },
        ...
        },
        {
          type: 'list',
          items: [
            'MetaMask: MetaMask is one of the most popular Web3 wallets that allows you to interact with decentralized applications (dApps) like Quantara. You can download MetaMask as a browser extension for Chrome, Firefox, or Brave, or as a mobile app for iOS and Android.',
            'Other Wallets: Quantara supports multiple Web3 wallets. You may also choose other wallets like WalletConnect, Coinbase Wallet, or Trust Wallet, depending on your preferences and device compatibility.',
          ],
        },
        ...
        {
          type: 'text',
          value: 'Connect Your Wallet to Quantara',
        },
        {
          type: 'list',
          items: [
            "After funding your wallet, go to the Quantara platform and look for the “Connect Wallet” button, typically found in the top-right corner of the homepage. Select your wallet type (e.g., MetaMask, WalletConnect) and follow the prompts to authorize the connection. Your wallet will ask for permission to connect with Quantara; confirm this request to allow your wallet to interact with the platform. If you’re using a wallet like MetaMask that doesn’t support Starknet by default, you may need to manually add the Starknet network by selecting “Custom RPC” in your wallet settings and entering the necessary network details. Once connected, you'll have full access to Quantara’s features.",
          ],
        },
      ],
    },
  ...
  return (
    <div className="relative flex min-h-screen flex-row">
      ...
      <div className="relative ml-4 min-h-screen flex-1 px-7 py-6 md:px-4 md:py-12">
        <h1 className="mt-16 mb-8 text-3xl font-bold text-white">Quantara Documentation</h1>
        <div className="ml-8">
