...
```bash
(env) jagadeesh@DESKTOP-DO11A83:~/ODhack/quantara$ PYTHONPATH=. python3 web_app/contract_tools/airdrop.py
{}
airdrops=[]
(env) jagadeesh@DESKTOP-DO11A83:~/ODhack/quantara$ cat web_app/contract_tools/airdrop.py | grep END
...
None
(env) jagadeesh@DESKTOP-DO11A83:~/ODhack/quantara$
```
...
- The airdrop script to fetch proofs for the specified contract address using ZkLend endpoints is implemented in:  
  [Quantara - airdrop.py](https://github.com/djeck1432/quantara/blob/main/web_app/contract_tools/airdrop.py)  
