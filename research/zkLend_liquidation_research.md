...
This research explored how to check and verify that zkLend closed a position due to liquidation rather than by a user through the Quantara smart contract, particularly focusing on the deployed Quantara smart contract, the events emitted by the zkLend contract and the state changes associated with liquidation.
...
### User Activity
1. **Check Events in Deployed Quantara Contract**: The `Events` logs of the Quantara contract were examined on [Starkscan](https://starkscan.co/contract/0x05685d6b0b493c7c939d65c175305b893870cacad780842c79a611ad9122815f#events). Only two events were observed; `LiquidityLooped` and `OwnershipTransferred`
...
**Note:** 2445961085966391684481990189941877317677508041889657123170411312758682452319 is integer representaion of the Quantara contract address
...
The deployed Quantara contract is yet to be liquidated by zkLend as evident by:
